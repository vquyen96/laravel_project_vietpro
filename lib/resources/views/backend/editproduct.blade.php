						...
						<div class="row" style="margin-bottom:40px">
							<div class="col-xs-8">
								<div class="form-group" >
									...
									<input required type="text" name="name" class="form-control"  value="{{$product->prod_name}}" value="{{$product->prod_name}}">
								</div>
								<div class="form-group" >
								...
								<div class="form-group" >
									...
									<select required name="status" class="form-control"  value="{{$product->prod_status}}">
								...
								<div class="form-group" >
									...
									<select required name="cate" class="form-control"  value="{{$product->prod_cate}}">
